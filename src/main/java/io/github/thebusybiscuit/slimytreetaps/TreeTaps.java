...
public class TreeTaps extends JavaPlugin implements SlimefunAddon {
	...
	public void onEnable() {
		...
		SlimefunItemStack amberBlock = new SlimefunItemStack("AMBER_BLOCK", Slimefun.getMinecraftVersion().isAtLeast(MinecraftVersion.MINECRAFT_1_16) ? Material.SHROOMLIGHT: Material.GLOWSTONE, "&6琥珀方塊");
		...
		ItemGroup itemGroup = new ItemGroup(new NamespacedKey(this, "tree_taps"), new CustomItemStack(treeTap, "&6黏液橡膠龍頭", "", "&a> 點擊開啟"));
	...
	public String getBugTrackerURL() {
		return "https://github.com/SlimeTraditionalTranslation/Slimytreetaps/issues";
	}
